...
songslist:Array<songlist>=[
  ...
  {pre:true,idi:0,singerid:0,songname:"abcd",totallikes:440,star:false},
  {pre:true,idi:1,singerid:0,songname:"abcd",totallikes:440,star:false},
  {pre:false,idi:2,singerid:0,songname:"abcd",totallikes:440,star:false},
  {pre:true,idi:3,singerid:0,songname:"abcd",totallikes:440,star:false},
  {pre:false,idi:4,singerid:0,songname:"abcd",totallikes:440,star:false},

  {pre:true,idi:0,singerid:1,songname:"xyz",totallikes:52,star:false},
  {pre:true,idi:1,singerid:1,songname:"xyz",totallikes:52,star:false},
  {pre:true,idi:2,singerid:1,songname:"xyz",totallikes:52,star:false},
  {pre:true,idi:3,singerid:1,songname:"xyz",totallikes:52,star:false},
  {pre:true,idi:4,singerid:1,songname:"xyz",totallikes:52,star:false},

  // {pre:true,idi:0,singerid:2,songname:"toy",totallikes:250},
  // {pre:true,idi:1,singerid:2,songname:"toy",totallikes:250},
  // {pre:true,idi:2,singerid:2,songname:"toy",totallikes:250},
  // {pre:true,idi:3,singerid:2,songname:"toy",totallikes:250},
  // {pre:true,idi:4,singerid:2,songname:"toy",totallikes:250},
